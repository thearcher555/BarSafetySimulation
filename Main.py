...
# window=tk.Tk()
# greeting = tk.Label(text="Hello mom")
# greeting.pack()
...
def printmetest():
   print("LOLOLOLOLOLOLOLOLOLOLOLOLOLOLOLHAHAHHAAHAHAHAHAHAHIFWNEQFNQOF")
...
if __name__ == "__main__":
   ...
   text_disp= tk.Button(frame,
                 text="get bar data",
                 command=lambda:[Simulator.getBarData(), Simulator.shmovement()]
